...
### 💬 Internal messaging (Phase 2 — core)

- **Floating messaging deck** (bottom-left, on every screen) with conversation list, chat window, and **1:1 + group chat for admins and staff**, plus a **Team Directory**.
