  ...
  return (
    <div className="max-w-sm mx-auto px-6 py-16">
      <div className="flex items-end justify-between mb-8 flex-wrap gap-3">
        <div>
          <div className="label">Admin · Security</div>
          <h1 className="font-display text-4xl tracking-tightest leading-none mt-2">Change password</h1>
        </div>
        <Link to="/admin/setup" className="btn-secondary text-xs">Back</Link>
      </div>
